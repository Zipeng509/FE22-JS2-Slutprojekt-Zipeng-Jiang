...
})({"kbf7m":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "f70ece6cbb76b110";
"use strict";
...
const firebaseConfig = {
    ...
    databaseURL: "https://js2-slutprojekt-zipeng-jiang-default-rtdb.europe-west1.firebasedatabase.app"
};
// Initialize Firebase
let app;
if (!app) app = (0, _app.initializeApp)(firebaseConfig);
// Initialize Realtime Database and get a reference to the service
const database = (0, _database.getDatabase)(app);
//Skapar användare
async function createUser(name, password, image, successCallback, failureCallback) {
    if (await isUserNameAlreadyExisting(name)) {
        failureCallback();
        return;
    }
    await (0, _database.set)((0, _database.ref)(database, "users/" + name), {
        name,
        password,
        image
    });
...
async function isUserNameAlreadyExisting(name) {
    const snapshot = await (0, _database.get)((0, _database.ref)(database, "users/" + name));
    const user = snapshot.val();
    return user?.name === name;
}
//Radera användare
async function removeUser(name) {
    await (0, _database.remove)((0, _database.ref)(database, "users/" + name));
}
//Får alla användare
async function getAllUsers() {
    const snapshot = await (0, _database.get)((0, _database.ref)(database, "users/"));
    if (!snapshot.exists) throw new Error("All users not found");
    const allUsersPost = snapshot.val();
    return Object.values(allUsersPost);
}
//Logga in
async function signIn(name, password, callback) {
    const snapshot = await (0, _database.get)((0, _database.ref)(database, "users/" + name));
    if (!snapshot.exists) throw new Error("Username not found");
    const user = snapshot.val();
    const isSignedIn = user.password === password;
    if (isSignedIn) callback();
}
//Skapar inlägg
async function createPost(name, post) {
    await (0, _database.set)((0, _database.ref)(database, "post/" + name + "/" + post.title), {
        ...post,
        createdAt: post.createdAt.toISOString()
    });
}
//Ta emot andra användares inlägg
async function getUserPost(name) {
    const snapshot = await (0, _database.get)((0, _database.ref)(database, "post/" + name));
    if (!snapshot.exists) throw new Error("User post not found");
    const userPost = Object.values(snapshot.val() || {});
    return userPost.map((post)=>({
            ...post,
            createdAt: new Date(post.createdAt)
        })).sort((a, b)=>{
        if (a.createdAt.getDate() < b.createdAt.getDate()) return 1;
        else if (a.createdAt.getDate() > b.createdAt.getDate()) return -1;
        return 0;
    });
}

},{"firebase/app":"aM3Fo","firebase/database":"SJ4UY","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aM3Fo":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _app = require("@firebase/app");
...
var global = arguments[3];
var process = require("de7f006d2309ba32");
const CONSTANTS = {
    /**
...
},{"de7f006d2309ba32":"d5jf4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"d5jf4":[function(require,module,exports) {
...
var _util = require("@firebase/util");
var _logger = require("@firebase/logger");
var process = require("cc7619431f1e0658");
...
},{"cc7619431f1e0658":"d5jf4","@firebase/app":"3AcPV","@firebase/component":"bi1VB","@firebase/util":"ePiK6","@firebase/logger":"fZmft","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["kbf7m"], null, "parcelRequire0b32")

//# sourceMappingURL=otherusersprofile.bb76b110.js.map
