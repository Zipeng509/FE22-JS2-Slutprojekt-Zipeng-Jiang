...
})({"8xPXq":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "81aa3a223460b8af";
"use strict";
...
},{}],"1TFqL":[function(require,module,exports) {
...
if (usernameElement) usernameElement.innerText = localStorage.getItem("signedInUser") ?? "";
signOutBtnElement?.addEventListener("click", ()=>{
    (0, _signout.signOut)();
});
async function otherUserTemplate(user) {
    const postAmount = (await (0, _firebase.getUserPost)(user.name)).length;
    return `
...
(0, _firebase.getAllUsers)().then(async (users)=>{
    if (getAllUsersElement) {
        ...
        users.map((user)=>{
            const goToProfileBtnElement = document.getElementById(user.name + "-btn");
...
},{"./signout":"aH921","./firebase":"KzVkO"}],"aH921":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["8xPXq","1TFqL"], "1TFqL", "parcelRequire0b32")

//# sourceMappingURL=otherusers.3460b8af.js.map
